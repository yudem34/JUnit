...
public class C04_Assertions2 {
    ...
    @Test
    public void test1() {
        // 1- titleTest => Sayfa başlığının “YouTube” oldugunu test edin
    ...
    @Test
    public void test3() {
        // 3- Search Box 'in erisilebilir oldugunu test edin (isEnabled())
    ...
    public void test4(){
        ...
        String unExtectedTitle2="youtube";
        String actualTitle2=driver.getTitle();
        Assert.assertFalse(actualTitle2.contains(unExtectedTitle2));
    }
    @AfterClass
