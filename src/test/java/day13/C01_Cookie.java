...
public class C01_Cookie extends TestBaseBeforAfter {
    @Test
    public void test1() {
        ...
        tumCookie.stream().filter(t-> t.getName().equals("i18n-prefs")).forEach(t-> Assert.assertEquals("USD",t.getValue()));
        ...
        Assert.assertEquals(skinCookie, null);*/
